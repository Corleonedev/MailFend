...
const Landing = () => (
        ...
        <div className="flex flex-col mt-7  items-center text-center justify-center ">
            <div className="flex flex-col p-2 border-2 items-center justify-center">
               ...
               <motion.p className="text-[38px] flex font-semibold flex-col items-center justify-center ">
                    Navigate Email with  Ease: Your Inclusive Email Solution- <span className="flex items-center justify-center">MailFend<img src={logo} /></span>
                </motion.p>
            ...
            <div className="mt-7">
                <h1 className="text-3xl mb-2 underline font-semibold">What Our App Offers</h1>
    ...
    <li className="flex items-center justify-between">
        <div className="flex-grow">User-Friendly Interface and Intuitive Navigation</div>
        <img className="h-12" src={correct} alt="Correct Icon" />
    </li>
</ul>
            ...
            <div className="mt-14">
                <Button className="" endIcon={<ArrowForward />} variant="contained"> <Link to="/login">Get Started</Link> </Button>
